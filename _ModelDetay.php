            ...
            <div class="mb-3 mt-1">        <!--  MODEL ADI VE KUMAŞ BİLGİSİ ALANI  -->
                ...
                <div class="row g-0">
                    <div class="col-md-3 mt-2">
                        <img src="ModelPic/<?= $row["modelResmi"] ?>" class="mx-auto d-block rounded img-fluid" alt="<?= $row["modelAdi"] ?>">
                    </div>
                    ...
                    <div class="col-md-9">
                        <!-- Resim Yanı Bilgileri-->
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-9 col-sm-12 text-center"><a href="#"class="btn btn-success"><?= rakam($row["kumasFiyat"]) ?> ₺ </a></div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3 col-sm-12 text-center">Kesilen Kumaş</div>
                                <div class="col-md-9 col-sm-12 text-center"><a href="#" class="btn btn-success"><?= $row["kumasMiktari"] ?>  <?= $row["kesimTuru"] ?></a>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3 col-sm-12 text-center">Kesim Adedi</div>
                                <div class="col-md-9 col-sm-12 text-center"><a href="#" class="btn btn-success"><?= $row["kesimAdedi"] ?></a>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3 col-sm-12 text-center">Kesim Tarihi</div>
                                <div class="col-md-9 col-sm-12 text-center"><a href="#"  class="btn btn-success"><?= tarihCevir($row["maliyetTarihi"]) ?></a>
                                </div>
                            </div>
                                <div class="row mt-3">
                                    <div class="col-md-3 col-sm-12 text-center">Birim Maliyet</div>
                                    <div class="col-md-9 col-sm-12 text-center"><a href="#" class="btn btn-danger mb-2"><?= rakam(getBirimMaliyet($modelID)) ?>  ₺</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row sm-2 mt-3 text-center">
                            <div class="col d-grid btn-outline-danger"><b>Maliyet Detayları </b></div>
                        </div>
                        <?php
        ...
        WHERE model.modelID = " . $modelID . " ORDER BY maliyetTarihi asc";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div class="row mb-2 btn-outline-warning text-dark border-bottom">
                                <div class="col-md-2"><small><?= tarihCevir($row["maliyetTarihi"]) ?></small></div>
                                <div class="col-md-4"><?= $row["maliyetAdi"] ?></div>
                                <div class="col-md-6 text-end"><?= rakam($row["maliyetFiyat"]) ?> ₺</div>
                            </div>
                            <?php
                        }
                        $conn->close();
                        ...
                        <div class="row mb-2 border-bottom border-top-0 ">
                            ...
                            <div class="col-md-8 text-end">
                                <a href="#" class="btn btn-danger mb-2"><?= rakam(getBirimMaliyet($modelID)) ?>  ₺</a>
                        ...
                        <div class="container col-12">
                            <div class="row sm-2 mt-3 text-center">
                                <div class="col d-grid btn-outline-primary"><b>Model Hareketleri</b></div>
                            </div>
